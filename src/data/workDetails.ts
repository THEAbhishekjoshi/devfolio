export const workDetails = [
    {
      ...
      formance tracking and debugging`
        ...
        techStacks: [
            ...
            { name: "Node.js", iconLink: "/TechIcons/node.png" },
            { name: "PostgreSQL", iconLink: "/TechIcons/postgres.png" },
            { name: "Langchain", iconLink: "/TechIcons/langchain.png" },
            { name: "NextJs", iconLink: "/TechIcons/nextjs.svg" },
            { name: "Supabase", iconLink: "/TechIcons/supabase.png" },
            { name: "TypeScript", iconLink: "/TechIcons/ts.svg" },
            { name: "Render", iconLink: "/TechIcons/render.jpeg" },
            { name: "FastMcp", iconLink: "/TechIcons/fastmcp.jpeg" },
            { name: "N8N", iconLink: "/TechIcons/n8n.svg" },
    ...
    },
    {
        ...
        techStacks: [
            { name: "React", iconLink: "/TechIcons/react.png" },
            { name: "Node.js", iconLink: "/TechIcons/node.png" },
            { name: "MongoDB", iconLink: "/TechIcons/mongodb.svg" },
            { name: "Vercel", iconLink: "/TechIcons/vercel.svg" },
            { name: "Render", iconLink: "/TechIcons/render.jpeg" },
        ],
